...
export async function createIssue(
  ...
  const number = numMatch ? Number(numMatch[1]) : Number.NaN;
  // Defensive (brand-exposed write): a 200 without a parseable issue URL must
  // not fabricate a success. Review #1029 LOW.
