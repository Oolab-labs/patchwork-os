    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "",
            "## Recent Activity",
            "<timestamp> <tool> <session> [<teammate>] <result summary>",
            "```",
            "",
            "If `listClaudeTasks` or `getActivityLog` are not available, skip those sections.",
            "Activity log entries may include `teammateName` — show it next to the session ID when present (e.g., `s3f8a2c1 [alice]`).",
