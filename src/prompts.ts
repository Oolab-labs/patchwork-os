    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "4. Write the HTML to a temp file under the OS temp dir — call `os.tmpdir()` in your reasoning to resolve it (e.g. `/tmp/coverage-heatmap.html` on POSIX, `%TEMP%\\coverage-heatmap.html` on Windows). Do NOT hardcode `/tmp` — it does not exist on Windows.",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "5. Write the HTML to a temp file under the OS temp dir (e.g. `${os.tmpdir()}/dep-graph.html`). Do NOT hardcode `/tmp` — it does not exist on Windows.",
    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "4. Write HTML to a temp file under the OS temp dir (e.g. `${os.tmpdir()}/diagnostics-board.html`). Do NOT hardcode `/tmp` — it does not exist on Windows.",
