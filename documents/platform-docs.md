...
177 tools · 36 MCP prompts · 24 automation hooks · 47 connectors (OAuth/PAT integrations — Slack, GitHub, Linear, Gmail, Google Calendar, Google Drive, Sentry, Notion, Confluence, Datadog, HubSpot, Intercom, Stripe, Zendesk, Jira, PagerDuty, Discord, Asana, GitLab, Telegram — plus database/data connectors like Postgres, MongoDB, Redis; see [README](../README.md) for the canonical list) — current version in [package.json](../package.json)
